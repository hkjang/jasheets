...
async function main() {
  ...
  try {
      ...
      console.log('Cleanup failed (maybe table empty or connection error), continuing...', e);
  }
  ...
  try {
      ...
      console.error('Failed to update user to admin. User might not exist if registration failed silently.', e);
      return;
  }
