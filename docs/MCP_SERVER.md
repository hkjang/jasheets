...
| `search_workbook` | Search values and formulas across a workbook with bounded cursor pagination | No |
| `rollback_revision` | Safely undo a cell revision without overwriting newer edits | Yes |
